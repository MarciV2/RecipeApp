...
public class DEMO_ORIEadapter extends RecyclerView.Adapter<DEMO_ORIEadapter.ORIEViewHolder> {

    private List<OwnRecipeIngredientElement> orieList;
    private CreateOwnRecipeActivity createOwnRecipeActivity;
    private ArrayAdapter<String> arrayAdapter;

    public DEMO_ORIEadapter(List<OwnRecipeIngredientElement> orieList, CreateOwnRecipeActivity createOwnRecipeActivity) {
    ...
    @Override
    public DEMO_ORIEadapter.ORIEViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
